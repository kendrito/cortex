/**
 * Package-owned invariant companion for `@cortex/session-query-sqlite`.
 * @module @cortex/session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@cortex/session-query-sqlite'
