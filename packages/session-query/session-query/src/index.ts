 ...
 *
 * @module @cortex/session-query
 */

import { Context, Service } from '@cortex/cordis'
import { Session, snapshotSessionEvent, type SessionId } from '@cortex/session'
import { foldSessionTitle } from '@cortex/session-title'
import type { SessionTitleSnapshot } from '@cortex/session-title'
import type {
