...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from '@cortex/session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from '@cortex/session'
