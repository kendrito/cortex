 ...
 * twin of `cortex-tool-bash`'s background adaptation.
 *
 * @module @cortex/tool-pwsh/background
 */

import type { ShellProcess } from '@cortex/shell'

/* jscpd:ignore-start -- deliberate twin of cortex-tool-bash/background.ts (Agent Note). */
