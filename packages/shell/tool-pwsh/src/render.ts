 ...
 * `cortex-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @cortex/tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@cortex/shell'
import type { SandboxMode } from '@cortex/sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@cortex/sandbox'

/* jscpd:ignore-start -- deliberate twin of cortex-tool-bash/render.ts (Agent Note). */
