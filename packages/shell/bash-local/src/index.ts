...
export class LocalBashExecutor extends ShellExecutor {
  ...
  resolve(request: ShellExecRequest): ShellExecSpec {
    ...
    return {
      ...
      // Carry stdin/ordinary env/trusted cortexEnv through verbatim — optional,
  ...
  private spawnSpec(
    ...
    return {
      ...
      signal,
      // One explicit env map for the seam, layered so the trusted cortexEnv
