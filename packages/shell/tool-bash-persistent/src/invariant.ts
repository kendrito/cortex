/**
 * Package-owned invariant companion for `@cortex/tool-bash-persistent`.
 * @module @cortex/tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@cortex/tool-bash-persistent'
