 ...
 * `@cortex/bash-sandbox`. It wraps the exact local pwsh argv through
...
import { SandboxUnavailableError } from '@cortex/sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,
...
import type { Config as LocalConfig } from '@cortex/pwsh-local'
