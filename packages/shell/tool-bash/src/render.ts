 ...
 *
 * @module @cortex/tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@cortex/shell'
 ...
 * rendering story, owned by `@cortex/shell` so `cortex-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@cortex/shell'
