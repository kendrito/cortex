/**
 * Package-owned invariant companion for `@cortex/settings-file`.
 * @module @cortex/settings-file/invariant
 */
...
const PACKAGE_NAME = '@cortex/settings-file'
 ...
 * tests; the in-process commit relation is owned by `@cortex/settings`.
 */
