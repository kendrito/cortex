...
import type { Agent, AgentOptions, AgentSetup } from '@cortex/agent'
...
import type {} from '@cortex/typert-registry'
...
export async function inspectApiRemoteSession(
  ...
  if (persistence === undefined) {
    throw new Error('session persistence is not configured (load a cortex-session-persistence backend)')
  }
