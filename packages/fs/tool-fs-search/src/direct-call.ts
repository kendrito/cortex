/** Shared top-level-call post-policy selection for search result spill. @module cortex-tool-fs-search/direct-call */

import type { Context } from '@cortex/cordis'
import type { JsonValue, PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from '@cortex/tools'
