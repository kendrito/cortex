 ...
 * @module @cortex/tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@cortex/cordis'
import { AttachmentError, AttachmentId } from '@cortex/attachment'
import type { ImageAttachmentRef, ImageMediaType } from '@cortex/attachment'
import { createUserMessage } from '@cortex/llm'
import type { ContentBlock } from '@cortex/llm'
import { defineTool } from '@cortex/tools'
import type { GenericCallView, ToolExecution } from '@cortex/tools'
import type {} from '@cortex/fs'
