 ...
 * streams large files, and rejects binary data; line windows belong to `cortex-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module @cortex/fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from '@cortex/fs'
