/**
 * Package-owned invariant companion for `@cortex/tool-str-replace-editor`.
 * @module @cortex/tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@cortex/tool-str-replace-editor'
