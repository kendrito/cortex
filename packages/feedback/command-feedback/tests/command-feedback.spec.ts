...
import SessionStore, { foldSurface, Session, SessionId } from '@cortex/session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@cortex/session-telemetry'
...
vi.mock('@cortex/anonymous-user-id', () => ({
...
describe('@cortex/command-feedback registration', () => {
