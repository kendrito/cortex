 ...
 * @module @cortex/message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@cortex/cordis'
import s from '@cortex/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@cortex/session/surface'
import type { SessionHeader, SessionId } from '@cortex/session/types'
import type { SessionInspection } from '@cortex/session-persistence'
import type { KvTable } from '@cortex/storage-domain'
import { TypertRemoteService, Remote } from '@cortex/typert-protocol'
