...
| Package | Role |
|---|---|
| `@cortex/spill` (this) | Service Definition: abstract service + vocabulary types |
| `@cortex/spill-local` | Service Provider: private session-scoped files on the host filesystem |
| `@cortex/spill-policy` | Consumer: the tool-result policy that spills oversized final results |
