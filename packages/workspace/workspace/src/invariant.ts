/**
 * Package-owned invariant companion for `@cortex/workspace`.
 * @module @cortex/workspace/invariant
 */
...
import { WorkspaceId } from '@cortex/workspace'

const PACKAGE_NAME = '@cortex/workspace'
