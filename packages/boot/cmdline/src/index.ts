/**
 * @cortex/cmdline — the command line a cortex launcher hands to the app
 * it boots.
 *
 ...
 * verbatim and in argv order. `cortex --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
