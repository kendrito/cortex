/**
 * Package-owned invariant companion for `@cortex/client-ui-trajectory`.
 * @module @cortex/client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-trajectory'
