/**
 * Package-owned invariant companion for `@cortex/client-ui-directory-picker-native`.
 * @module @cortex/client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-directory-picker-native'
