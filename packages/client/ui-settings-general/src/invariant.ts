/**
 * Package-owned invariant companion for `@cortex/client-ui-settings-general`.
 * @module @cortex/client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-settings-general'
