/**
 * Package-owned invariant companion for `@cortex/client-ui-plan`.
 * @module @cortex/client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-plan'
 ...
 * audited by cortex-plan-mode, while the control is a slot effect whose
