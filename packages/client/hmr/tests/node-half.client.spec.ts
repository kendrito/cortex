...
import type { WebBootGraph, ClientModuleRegistry } from '@cortex/client-modules'
import type { WebRoute, WebServer } from '@cortex/host-webserver'
...
beforeEach(() => { dir = mkdtempSync(join(tmpdir(), 'cortex-hmr-')) })
