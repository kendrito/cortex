 ...
 * @module @cortex/client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@cortex/typert-protocol'
import type { HostObservable } from '@cortex/client-ui-slots'
import type { MessageId, SessionId } from '@cortex/client-connection/client'
import type {
...
} from '@cortex/message-feedback/types'
