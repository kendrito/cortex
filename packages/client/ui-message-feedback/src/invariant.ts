/**
 * Package-owned invariant companion for `@cortex/client-ui-message-feedback`.
 * @module @cortex/client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-message-feedback'
