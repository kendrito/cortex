...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@cortex/client-ui-theme/client'
import { apply, inject, LayoutController } from '@cortex/client-ui-layout/client'
import { apply as nodeApply } from '@cortex/client-ui-layout'
import * as invariant from '@cortex/client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@cortex/client-ui-layout', expect.any(Function))
