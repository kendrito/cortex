...
/** Viewport width below which the sidebar auto-collapses to the rail (the design
 * system LG breakpoint); a manual toggle below it re-expands over the squeezed center
