...
import type { ComposerChainProps } from '@cortex/client-ui-conversation/client'
import { InputTriggerService } from '@cortex/client-ui-input-trigger/client'
import type { ClientSessionContext, InputTriggerSource } from '@cortex/client-ui-input-trigger/client'
import { apply as applyLocale, inject as localeInject } from '@cortex/client-locale/client'
import {
