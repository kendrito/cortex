 ...
 * determinism
 * lives host-side — the pre-step boundary (`cortex-tool-skill`) recognizes a
...
import type { ConnectionHandle, SessionId, SkillEntry } from '@cortex/api-remotes/client'
import type { ClientContext, ISessions } from '@cortex/client-runtime/client'
import type { InputTriggerServiceContract, InputTriggerSource } from '@cortex/client-ui-input-trigger/client'
...
export function apply(ctx: ClientContext): void {
  ...
  const source: InputTriggerSource = {
    ...
    onPick({ candidate }) {
      ...
      // pre-step boundary (cortex-tool-skill) recognizes the leading /name and
