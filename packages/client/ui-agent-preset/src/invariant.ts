/**
 * Package-owned invariant companion for `@cortex/client-ui-agent-preset`.
 * @module @cortex/client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-agent-preset'
