/**
 * Browser theme registry over the `--cortex-*` token stylesheets. The service
...
import type { BoundActions } from '@cortex/client-ui-slots'
import type { ClientContext, SettingsScope } from '@cortex/client-runtime/client'
...
/** Theme token dictionary: --cortex-alias-* overrides keyed by variable name. */
...
const BUILTIN_INSPECT_TOKENS: readonly ThemeTokenInspection[] = Object.freeze([
  { name: '--cortex-alias-bg-base', description: 'Application base background.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-bg-base' },
  { name: '--cortex-alias-bg-layer-1', description: 'Primary raised surface background.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-bg-layer-1' },
  { name: '--cortex-alias-bg-layer-2', description: 'Secondary nested surface background.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-bg-layer-2' },
  { name: '--cortex-alias-bg-overlay', description: 'Overlay and popover background.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-bg-overlay' },
  { name: '--cortex-alias-border-l1', description: 'Primary subtle border.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-border-l1' },
  { name: '--cortex-alias-border-l2', description: 'Secondary stronger border.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-border-l2' },
  { name: '--cortex-alias-brand-primary', description: 'Primary brand accent.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-brand-primary' },
  { name: '--cortex-alias-label-primary', description: 'Primary text color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-label-primary' },
  { name: '--cortex-alias-label-secondary', description: 'Secondary text color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-label-secondary' },
  { name: '--cortex-alias-state-error-primary', description: 'Primary error state color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-state-error-primary' },
  { name: '--cortex-alias-state-success-primary', description: 'Primary success state color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-state-success-primary' },
  { name: '--cortex-alias-state-warn-primary', description: 'Primary warning state color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-alias-state-warn-primary' },
  { name: '--cortex-specific-sidebar-fill', description: 'Sidebar column and title-row background.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--cortex-specific-sidebar-fill' },
])
