/**
 * Package-owned invariant companion for `@cortex/client-ui-deliverables`.
 * @module @cortex/client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-deliverables'
