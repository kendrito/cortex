...
import type { ChatFileMentions, TurnTailOwnerProps } from '@cortex/client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@cortex/client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@cortex/client-ui-deliverables'])
