...
import { SlotCore, type PropsRenderSlots, type SlotRendererHost } from '@cortex/client-ui-slots'
import { createSlotRenderer, StaleAuthorizationError } from '@cortex/client-web-react'
