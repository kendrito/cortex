...
export function issue(overrides: Overrides<IssueRecord> = {}): IssueRecord {
  return merged<IssueRecord>({
    ...
    type: 'Story',
    priority: 'High',
    assignee: { name: 'Kendrito', id: 'kendrito' },
    ...
    storyPoints: 5,
    comments: [
      { id: '2', author: { name: 'Kendrito' }, created: new Date(NOW - 60_000).toISOString(), body: 'Fresh comment' },
...
export function pr(overrides: Overrides<PrRecord> = {}): PrRecord {
  return merged<PrRecord>({
    ...
    state: 'OPEN',
    author: { name: 'Kendrito', id: 'kendrito' },
    reviewers: [
