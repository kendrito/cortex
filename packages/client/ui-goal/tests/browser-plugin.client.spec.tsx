...
import { ConversationEventRegistry } from '@cortex/client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@cortex/goal/client'
