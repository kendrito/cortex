...
import type { GoalSnapshot } from '@cortex/goal/client'
import {
...
import type { PropsLocale } from '@cortex/client-ui-slots'
...
export type GoalDockProps = import('@cortex/client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
