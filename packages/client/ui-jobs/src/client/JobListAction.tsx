...
import type { JobView } from '@cortex/client-runtime/client'
import { IconChevronDownOutline14, StateDot, type StateDotState } from '@cortex/client-ui-primitives'
import type { PropsLocale, PropsRuntime, TranslateNS } from '@cortex/client-ui-slots'
