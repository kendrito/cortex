...
import type { PropsLocale, PropsRuntime } from '@cortex/client-ui-slots'
...
import type { TodoItem } from '@cortex/tool-todo/client'
import { IconChecklistOutline14, IconChevronDownOutline14, IconChevronUpOutline14 } from '@cortex/client-ui-primitives'
...
/** Local exhaustiveness helper — client packages do not depend on `cortex-llm`. */
