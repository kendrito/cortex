...
import {
  CortexMark, IconChevronDownOutline14, IconFolderClose16, IconFolderOpen16,
} from '@cortex/client-ui-primitives'
import { workspaceTitleOf } from '@cortex/client-runtime/client'
      ...
      <div className={css.stack}>
        <div className={css.headline}>
          ...
          <span className={css.fishHitbox}>
            <CortexMark size={34} className={css.fish} />
          </span>
