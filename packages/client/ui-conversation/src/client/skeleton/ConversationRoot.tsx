...
import type { WorkspaceId } from '@cortex/client-runtime/client'
...
export function ConversationRoot({
  ...
  // Publishes the seat's live height as --cortex-composer-height on the scroll
  ...
  const seatResizeRef = useCallback((seat: HTMLDivElement | null): void => {
    ...
    seatObserver.current = new ResizeObserver(() => {
      scroller.style.setProperty('--cortex-composer-height', `${seat.offsetHeight}px`)
    })
