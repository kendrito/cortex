...
import { isReplacementSurfaceEvent } from '@cortex/client-runtime/client'
import type { CompactionCheckpointSource } from '@cortex/compaction/checkpoint'
import type {} from '@cortex/compaction/types'
import type {} from '@cortex/commands/types'
import type { ManualCompactionChatData } from '../contract/chat-nodes.ts'
import { chatNode } from './common.ts'

declare module '@cortex/client-ui-conversation/client' {
