/**
 * Package-owned invariant companion for `@cortex/client-ui-conversation`.
 * @module @cortex/client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-conversation'
