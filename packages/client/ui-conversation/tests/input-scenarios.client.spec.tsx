...
import type { ClientSessionContext, CommandClaim, PickOutcome, SubmitOutcome } from '@cortex/client-ui-input-trigger/client'
...
import type { ConversationSnapshot } from '@cortex/client-runtime/client'
...
const COMMANDS: FakeCommand[] = [
  { name: 'goal', description: 'Set up a goal', input: { hint: 'goal objective' } },
