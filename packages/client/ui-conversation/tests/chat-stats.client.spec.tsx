...
import { EMPTY_CONVERSATION_VIEWS } from '@cortex/client-runtime/client'
...
describe('StatsLine', () => {
  ...
  function props(
    ...
    return { useSession: bindSnapshotSelector(source), useProjection: projections(values), t }
  }
  ...
  it('takes every stats label from the dictionary', () => {
    const timed: AssistantMessageNode = {
      ...assistant(1, 1, { outputTokens: 60 }),
      timing: { stepStartTime: 1_000, firstTokenTime: 1_800, completedTime: 4_800 },
    }
