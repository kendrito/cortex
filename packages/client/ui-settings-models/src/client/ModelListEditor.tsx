...
import type { DiscoveredModelView, IApiClient } from '@cortex/api-remotes/client'
import { Button, Modal } from '@cortex/client-ui-primitives'
import { formatCapacity, parseCapacity } from './model-drafts.ts'
import type { CortexModelDraft } from './model-drafts.ts'
import { messageOf } from './store.ts'
import type { en } from './locales.ts'
import styles from './ModelsSection.module.css'

/**
 * One configured model row. Structurally open: a profile field this card does
 ...
 */
export type ModelDraft = CortexModelDraft
 ...
 * {@link formatCapacity}, the inverse of the {@link parseCapacity} read the
 * field makes, so the row reads and writes one K/M vocabulary.
