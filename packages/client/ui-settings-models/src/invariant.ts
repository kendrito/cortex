/**
 * Package-owned invariant companion for `@cortex/client-ui-settings-models`.
 * @module @cortex/client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-settings-models'
