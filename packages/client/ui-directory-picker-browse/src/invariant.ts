/**
 * Package-owned invariant companion for `@cortex/client-ui-directory-picker-browse`.
 * @module @cortex/client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-directory-picker-browse'
