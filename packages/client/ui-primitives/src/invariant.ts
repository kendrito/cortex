/**
 * Package-owned invariant companion for `@cortex/client-ui-primitives`.
 * @module @cortex/client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-primitives'
