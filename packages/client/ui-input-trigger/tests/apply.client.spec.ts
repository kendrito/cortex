...
import { createScope, scopeOf, SlotRegistry } from '@cortex/client-runtime/client'
import type { SessionId } from '@cortex/client-runtime/client'
import { apply, inject, InputTriggerService } from '@cortex/client-ui-input-trigger/client'
import type { MenuViewInjected } from '@cortex/client-ui-input-trigger/client'
