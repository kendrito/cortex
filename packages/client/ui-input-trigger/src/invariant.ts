/**
 * Package-owned invariant companion for `@cortex/client-ui-input-trigger`.
 * @module @cortex/client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-input-trigger'
