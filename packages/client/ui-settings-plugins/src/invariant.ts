/**
 * Package-owned invariant companion for `@cortex/client-ui-settings-plugins`.
 * @module @cortex/client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-settings-plugins'
