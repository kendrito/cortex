...
describe('ValueField', () => {
  ...
  it('hints a numeric keypad and renders a placeholder when asked', () => {
    ...
    expect(input).toHaveProperty('placeholder', 'https://api.example.com')
  })
...
describe('SecretField', () => {
  ...
  it('stages the draft and never renders it', () => {
    ...
    expect(onEdit).toHaveBeenCalledWith('test-secret')
  ...
  it('reports the configured state the Host holds', () => {
    ...
    expect(screen.getByLabelText('API key')).toHaveProperty('value', 'test-secret')
  })
