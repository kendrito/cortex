 ...
 * `window.__CORTEX_BOOT__` into the two-view BootManifest (wire boundary)
...
import * as ModulesClient from '@cortex/client-modules/client'
import {
  ClientModuleSystem, parseBootManifest,
  type BootManifest, type ClientModuleSystemOptions, type CortexWindow,
} from '@cortex/client-modules/client'
 ...
 * twice.
 */
const MODULES_ID = '@cortex/client-modules'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    this.manifest = parseBootManifest((globalThis as CortexWindow).__CORTEX_BOOT__)
    ...
    ;(globalThis as CortexWindow).__CORTEX_MODULES__ = this.modules
