 ...
 * @module @cortex/client-web/src/loader-status
 */
import type { FiberState } from '@cortex/cordis'
 ...
 * while retaining its type (same rationale as cortex-tool-cordis's mirror).
 */
