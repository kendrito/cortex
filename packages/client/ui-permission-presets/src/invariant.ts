/**
 * Package-owned invariant companion for `@cortex/client-ui-permission-presets`.
 * @module @cortex/client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-permission-presets'
