...
function writePackage(
  packageName: string,
  metadata: Record<string, unknown> = { cortex: { client: { platform: 'web' } } },
): string {
  root ??= realpathSync(mkdtempSync(join(tmpdir(), 'cortex-client-modules-')))
...
describe('client bundle activation', () => {
  it('allows sibling cortex roles', () => {
