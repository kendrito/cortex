/**
 * Package-owned invariant companion for `@cortex/client-ui-attachment`.
 * @module @cortex/client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-attachment'
