/**
 * Package-owned invariant companion for `@cortex/client-ui-model-selection`.
 * @module @cortex/client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-model-selection'
