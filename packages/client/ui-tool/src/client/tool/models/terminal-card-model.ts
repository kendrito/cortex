 ...
 * @module
 */
import { resolveWorkspacePath } from '@cortex/client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@cortex/client-ui-primitives'
 ...
 * `ToolResultNode.call`/`callView` in cortex-client-runtime), leaving a terminal
