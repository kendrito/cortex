...
import type { ToolResultView } from '@cortex/api-remotes/client'
import { bindSnapshotSelector } from '@cortex/client-web-react'
import type { SelectionTarget } from '@cortex/client-ui-conversation/client'
import type { ToolCallOwnerProps } from '@cortex/client-ui-tool/client'
import { IconGlobeOutline14 } from '@cortex/client-ui-primitives'
...
import { DetailsPanel } from '@cortex/client-ui-conversation/src/client/skeleton/DetailsPanel.tsx'
...
const SEARCH_ARGS = '{"query":"cortex harness"}'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@cortex/cordis').Context
