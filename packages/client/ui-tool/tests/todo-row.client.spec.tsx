...
import type { TodoItem, ToolResultNode } from '@cortex/client-runtime/client'
...
const LIST: TodoItem[] = [
  { content: 'Scaffold the project', status: 'completed' },
...
describe('TodoRow', () => {
  ...
  it('leading toggle expands the raw args body', () => {
    ...
    expect(screen.getByText(/Scaffold the project/)).toBeTruthy()
  })
