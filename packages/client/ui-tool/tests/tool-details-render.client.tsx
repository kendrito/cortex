...
import type { SessionProviderComponent, TranslateNS } from '@cortex/client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@cortex/client-ui-conversation/src/client/contract/slots.ts'
