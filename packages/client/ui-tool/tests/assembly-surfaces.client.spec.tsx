...
import type { ISession, SessionId, TodoItem, ToolResultNode } from '@cortex/client-runtime/client'
import type { PropsRenderSlots } from '@cortex/client-ui-slots'
import { SlotTestRuntime, usePinnedBrowserLanguages, stubSettingsScope } from '@cortex/client-test-runtime'
import { apply as applyConversation, inject as injectConversation } from '@cortex/client-ui-conversation/client'
...
const TODOS: TodoItem[] = [
  { content: 'Sort out requirements', status: 'completed' },
