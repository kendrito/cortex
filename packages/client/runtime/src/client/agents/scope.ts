 ...
 * Agent's identity. The mechanism mirrors the host `cortex-scope` architecture
...
import type { TypertClientRemote, TypertRemoteScopeApi } from '@cortex/typert-protocol'
...
const kScope = Symbol('cortex.client.scope')
