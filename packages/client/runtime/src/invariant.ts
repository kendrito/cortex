/**
 * Package-owned invariant companion for `@cortex/client-runtime`.
 * @module @cortex/client-runtime/invariant
 */
...
import type { SlotMap } from '@cortex/client-ui-slots'
import type { InvariantInstaller } from '@cortex/invariants'

const PACKAGE_NAME = '@cortex/client-runtime'
