/**
 * Package-owned invariant companion for `@cortex/client-ui-user-questions`.
 * @module @cortex/client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-ui-user-questions'
