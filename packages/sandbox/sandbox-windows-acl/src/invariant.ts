/**
 * Package-owned invariant companion for `@cortex/sandbox-windows-acl`.
 * @module @cortex/sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@cortex/sandbox-windows-acl'
