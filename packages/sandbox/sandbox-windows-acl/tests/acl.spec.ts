 ...
 * is the mandated lock infrastructure under <GetTempPathW()>\cortex-acl-locks,
...
const SID_STRUCT = koffi.struct('CORTEX_ACL_SPEC_SID', {
  revision: 'uint8',
...
describe.skipIf(!isWin32)('ACL editing', () => {
  ...
  function scratch(): string {
    const dir = mkdtempSync(join(tmpdir(), 'cortex-acl-edit-'))
