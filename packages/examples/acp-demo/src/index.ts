 ...
 * ({@link @cortex/agent-spine-demo}), JSONL session persistence, and
 * the {@link @cortex/acp} bridge. The app owns those plugins through one
...
} from '@cortex/session-persistence-jsonl'
...
export const Config: z<Config> = z.object({
  ...
  // order" (the owning cortex-system-prompt schema does the same), while
