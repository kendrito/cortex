...
} from '@cortex/cordis-host-runner'
import type { DynamicCordisReference } from '@cortex/cordis-host-runner'
...
function renderUnavailableReference(id: string): string {
  return [
    ...
    'It may have been removed, belong to another Session, or have been lost when the Cortex process restarted.',
