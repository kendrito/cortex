 ...
 * @module @cortex/cordis-host-runner/guard
 */

import { Context } from '@cortex/cordis'
import type { Plugin } from '@cortex/cordis'
import { scopeOf } from '@cortex/scope'
import { assertSupportedJsonSchema, defineTool } from '@cortex/tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@cortex/cordis-client-runner`, whose CTX_VERBS names this one its
