 ...
 * @module @cortex/cordis-host-runner
 */
...
import type { JsonValue } from '@cortex/session/types'
...
function missingPluginMessage(id: CordisDynamicPluginId): string {
  return `no dynamic plugin "${id}" in this process — it may have been removed or lost on Cortex restart`
}
