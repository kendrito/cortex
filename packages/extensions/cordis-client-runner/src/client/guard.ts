...
import type { DynamicCordisPackage } from '@cortex/api-remotes/client'
import type { SlotRegistry } from '@cortex/client-runtime/client'
import type { ThemeRuntime } from '@cortex/client-ui-theme/client'
      ...
      return (source: unknown, tokens: unknown): unknown => {
        ...
        if (tokens === undefined && typeof source === 'object' && source !== null) {
          return rejectGuard(env,
            ...
            + 'so pass any string first and the token map second: overrideTokens(\'mine\', { \'--cortex-alias-…\': { light: \'…\', dark: \'…\' } })',
          )
        }
