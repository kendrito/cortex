/**
 * Package-owned invariant companion for `@cortex/cordis-client-runner`.
 * @module @cortex/cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@cortex/cordis-client-runner'
