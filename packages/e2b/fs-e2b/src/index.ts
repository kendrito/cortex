...
import type { EntryInfo, Sandbox } from '@cortex/e2b'

const VERSION_METADATA_KEY = 'cortex-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.cortex-${randomUUID()}.tmp`)
