 ...
 * Concrete
 * providers such as `@cortex/skill-filesystem` decide where skills come
...
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@cortex/scope'
import type { ScopeKey, ScopeLayer } from '@cortex/scope'
...
export type SkillSource = 'project-cortex' | 'project-agents' | 'runtime' | 'user-cortex' | 'user-agents' | 'custom' | 'bundled' | (string & {})
