 ...
 *
 * @module @cortex/agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$CORTEX_HOME`.
 * Discovery (`$CORTEX_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.cortex/AGENTS.md' || displayPath === '$CORTEX_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
