 ...
 *
 * @module @cortex/agent-instructions/config
 */
...
export function resolveDiscoveryConfig(
  config: Pick<Config, 'cortexHome' | 'projectRootMarkers' | 'instructionFileCandidates' | 'localInstructionFileCandidates'>,
): ResolvedDiscoveryConfig {
  return {
    cortexHome: resolveCortexHome(config.cortexHome),
