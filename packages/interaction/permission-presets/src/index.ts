 ...
 *
 * @module cortex-permission-presets
 */
...
import { SANDBOX_MODES, effectiveSandboxMode, setSandboxMode } from '@cortex/sandbox-policy'
...
import type {} from '@cortex/shell'
import type { ApprovalPolicy } from '@cortex/user-approval'
import { APPROVAL_POLICIES, effectiveApprovalPolicy, setApprovalPolicy } from '@cortex/user-approval'
import { installSettingsSection, settingsNamespace } from '@cortex/settings'
