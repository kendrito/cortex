/**
 * cortex-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@cortex/brand`; this module
 ...
 * loading the host plugin's Context merges — the `cortex-llm/brand` shape.
 *
 * @module @cortex/commands/brand
 */
