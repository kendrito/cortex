...
The policy owner contributes capability-neutral `sandbox:policy` context. Through `@cortex/tool-terminal` or another PTY consumer, the model may also receive bounded MOTD, send deltas, scrollback pages, readiness reasons, and cleanup errors.
