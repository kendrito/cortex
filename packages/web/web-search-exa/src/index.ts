/**
 * `@cortex/web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@cortex/llm-pi-ai`
 * registers an adapter into `ctx.llm`. The key is owned by `@cortex/web`.
 *
 * @module @cortex/web-search-exa
 */
