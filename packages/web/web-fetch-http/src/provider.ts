 ...
 * `@cortex/tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @cortex/web-fetch-http/provider
 */

import { WebError } from '@cortex/web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@cortex/web'
