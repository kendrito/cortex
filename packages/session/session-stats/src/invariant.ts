/**
 * Package-owned invariant companion for `@cortex/session-stats`.
 * @module @cortex/session-stats/invariant
 */
...
const PACKAGE_NAME = '@cortex/session-stats'
 ...
 * ids) are owned and runtime-checked by cortex-agent-loop and the session
 * surface, not here.
 */
