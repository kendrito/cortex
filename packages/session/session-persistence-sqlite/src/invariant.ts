/**
 * Package-owned invariant companion for `@cortex/session-persistence-sqlite`.
 * @module @cortex/session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@cortex/session-persistence-sqlite'
