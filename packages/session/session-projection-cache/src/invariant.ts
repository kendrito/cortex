/**
 * Package-owned invariant companion for `@cortex/session-projection-cache`.
 * @module @cortex/session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@cortex/session-projection-cache'
