/**
 * Package-owned invariant companion for `@cortex/session-persistence`.
 * @module @cortex/session-persistence/invariant
 */
...
const PACKAGE_NAME = '@cortex/session-persistence'
