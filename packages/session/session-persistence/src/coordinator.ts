 ...
 * @module @cortex/session-persistence/coordinator
 */
...
import type { Session, SessionEvent, SessionId, SessionHeader } from '@cortex/session'
...
export class PersistenceCoordinator<TornMarker = unknown> {
  ...
  private installWritePath(): void {
    ...
    // sessions (mirrors cortex-invariants).
