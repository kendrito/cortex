 ...
 * @module @cortex/session-persistence
 */

import { Context, Service } from '@cortex/cordis'
import { SessionPreparation } from '@cortex/session'
import type { SessionEvent, SessionId, SessionHeader } from '@cortex/session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@cortex/session'
