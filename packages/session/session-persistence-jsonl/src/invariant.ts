/**
 * Package-owned invariant companion for `@cortex/session-persistence-jsonl`.
 * @module @cortex/session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@cortex/session-persistence-jsonl'
