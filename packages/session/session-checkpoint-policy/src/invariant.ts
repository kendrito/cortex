/**
 * Package-owned invariant companion for `@cortex/session-checkpoint-policy`.
 * @module @cortex/session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@cortex/session-checkpoint-policy'
