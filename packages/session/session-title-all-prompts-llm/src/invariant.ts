/**
 * Package-owned invariant companion for `@cortex/session-title-all-prompts-llm`.
 * @module @cortex/session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@cortex/session-title-all-prompts-llm'
