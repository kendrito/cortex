/**
 * Package-owned invariant companion for `@cortex/session-title-first-prompt-llm`.
 * @module @cortex/session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@cortex/session-title-first-prompt-llm'
