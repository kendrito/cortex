/**
 * Package-owned invariant companion for `@cortex/subagent-cortex-sdk`.
 * @module @cortex/subagent-cortex-sdk/invariant
 */
...
const PACKAGE_NAME = '@cortex/subagent-cortex-sdk'

/** Cordis companion plugin name. */
export const name = 'subagent-cortex-sdk-invariant'
