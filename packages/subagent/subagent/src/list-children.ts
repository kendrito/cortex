...
import type { SessionProjectionRegistry } from '@cortex/session-projection'
import type { SessionProjectionCache } from '@cortex/session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @cortex/session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @cortex/session)',
