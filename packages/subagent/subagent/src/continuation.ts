...
import { boundContextSummary, createUserMessage, errorChain } from '@cortex/llm'
...
import type { ToolRestriction } from '@cortex/tools'
...
export class SubagentContinuationManager {
  ...
  private requirePersistence(): SessionPersistence {
    ...
    if (persistence === undefined) {
      throw new SubagentError(
        'continuable subagents require session persistence (load a cortex-session-persistence backend)',
