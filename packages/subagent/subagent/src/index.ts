 ...
 * (`@cortex/subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@cortex/tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@cortex/tools'
import type { ContentBlock, MessageId } from '@cortex/llm'
