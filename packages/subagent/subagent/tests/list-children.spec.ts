...
import type { SessionEvent, SessionHeader } from '@cortex/session'
...
import SessionProjectionCache from '@cortex/session-projection-cache'
...
import SubagentRuntime, {
  ...
  SubagentError,
} from '@cortex/subagent'
import * as SubagentSpawn from '@cortex/subagent-spawn-in-process'
import * as SubagentFork from '@cortex/subagent-fork-in-process'
...
async function setup(
  ...
  const root = mkdtempSync(join(tmpdir(), 'cortex-subagent-list-'))
  roots.push(root)
