...
import SandboxPolicyService, { effectiveSandboxMode, setSandboxMode } from '@cortex/sandbox-policy'
...
import ApprovalService, { effectiveApprovalPolicy } from '@cortex/user-approval'
...
async function setup(script: Script) {
  ...
  const root = mkdtempSync(join(tmpdir(), 'cortex-continuation-inherit-'))
  roots.push(root)
