/**
 * Package-owned invariant companion for `@cortex/tool-subagent-control`.
 * @module @cortex/tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@cortex/tool-subagent-control'
