/**
 * Package-owned invariant companion for `@cortex/tool-subagent-report`.
 * @module @cortex/tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@cortex/tool-subagent-report'
