 ...
 * @module @cortex/subagent-in-process-driver/structured
 */

import type { Context } from '@cortex/cordis'
import type { ToolSchema } from '@cortex/llm'
import type { ToolExecution, ToolRunContext } from '@cortex/tools'
import { ToolArgsError, validateJsonSchemaValue, type ObjectJsonSchema } from '@cortex/tools'
 ...
 *   `assertObjectJsonSchema` in cortex-tools).
