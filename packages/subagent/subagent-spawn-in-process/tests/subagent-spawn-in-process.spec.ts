...
import { Context, symbols, type EffectMeta } from '@cortex/cordis'
...
import SubagentRuntime, { type SubagentStartRequest } from '@cortex/subagent'
import { MockAdapter, maxTokensResponse, textResponse, toolCallResponse } from '../../../core/agent-loop/tests/mock-adapter.ts'
import * as spawn from '../src/index.ts'
import { STRUCTURED_OUTPUT_TOOL } from '@cortex/subagent-in-process-driver'
...
describe('cortex-subagent-spawn-in-process', () => {
