 ...
 * (`@cortex/workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @cortex/tool-workflow
 */

import type { Context } from '@cortex/cordis'
import z from '@cortex/schemastery'
import { defineTool } from '@cortex/tools'
import type { ToolCallView, ToolResultView } from '@cortex/tools'
import type { ContentBlock } from '@cortex/llm'
import type { JsonValue, Session, SessionEventMap } from '@cortex/session'
import type {
