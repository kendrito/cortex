/**
 * Package-owned invariant companion for `@cortex/workflow-worker-thread`.
 * @module @cortex/workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@cortex/workflow-worker-thread'
