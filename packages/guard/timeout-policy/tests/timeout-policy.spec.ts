/**
 * Unit + real-load-path coverage for @cortex/tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@cortex/llm'
import SystemPrompt from '@cortex/system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@cortex/tools'
import * as timeoutPolicy from '@cortex/tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@cortex/tool-call-timeout-policy'
...
describe('cortex-tool-call-timeout-policy real-load-path guard', () => {
