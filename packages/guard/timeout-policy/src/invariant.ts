/**
 * Package-owned invariant companion for `@cortex/tool-call-timeout-policy`.
 * @module @cortex/tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@cortex/tool-call-timeout-policy'
