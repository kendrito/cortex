/**
 * Package-owned invariant companion for `@cortex/repeat-tool-reminder`.
 * @module @cortex/repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@cortex/repeat-tool-reminder'
