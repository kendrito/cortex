...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@cortex/llm'
import type { AppIdentity } from '@cortex/llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `cortex/${manifest.version} (+https://github.com/local/cortex)`,
    )
  })
