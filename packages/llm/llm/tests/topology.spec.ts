...
import LlmRuntime, { LlmAdapter, LlmError } from '@cortex/llm'
import type { GenerateOptions, LlmConfigurableProvider, StreamChunk } from '@cortex/llm'
...
describe('llm/adapters-updated', () => {
  ...
  it('replaces a route set in one event, never publishing an empty registry between the two', async () => {
    // The retry-policy swap in llm-pi-ai: disposing and re-registering
