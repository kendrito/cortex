/** Package-owned durable retry-event invariants. @module @cortex/llm-retry/invariant */

import type { Context } from '@cortex/cordis'
import type { Session, SessionEvent } from '@cortex/session'
import type { LlmFailure } from '@cortex/llm'
...
const PACKAGE_NAME = '@cortex/llm-retry'
