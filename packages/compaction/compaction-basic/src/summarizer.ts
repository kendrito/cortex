 ...
 *
 * @module @cortex/compaction-basic/summarizer
 */

import type { Context } from '@cortex/cordis'
import { contentHasImage, createUserMessage, BlockAssembler, LlmError } from '@cortex/llm'
import type {
...
export async function summarizeWithLlm(
  ...
  const messages: Message[] = [
    ...
    createUserMessage({
      ...
      source: { kind: 'plugin', plugin: 'cortex-compaction-basic' },
    }),
  ]
