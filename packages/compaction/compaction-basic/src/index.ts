 ...
 *
 * @module @cortex/compaction-basic
 */

import { Context } from '@cortex/cordis'
import z from '@cortex/schemastery'
import { CompactionEngine, ManualCompactionError } from '@cortex/compaction'
import type { CompactionResult, CompactionTrigger } from '@cortex/compaction'
import type { TokenMeter } from '@cortex/token-meter'
import type { Session } from '@cortex/session'
import { CONTEXT_WINDOW_EXCEEDED_CODE, assertNever } from '@cortex/llm'
import type { LlmCallConfig } from '@cortex/llm'
import type { Agent, PreStepDecision } from '@cortex/agent'
import type { CommandId } from '@cortex/commands/brand'
// Type-only: makes the optional sibling service available to `ctx.get()`.
import type {} from '@cortex/compaction-tool-result-pruner'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
