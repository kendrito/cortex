/**
 * Package-owned invariant companion for `@cortex/compaction-tool-result-pruner`.
 * @module @cortex/compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@cortex/compaction-tool-result-pruner'
