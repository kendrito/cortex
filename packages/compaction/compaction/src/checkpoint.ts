 ...
 *
 * The seam itself lives in `@cortex/compaction`, which re-exports these
 ...
 * `cortex-commands/brand` shape.
 *
 * @module @cortex/compaction/checkpoint
 */

import type { MessageSource } from '@cortex/llm/message'
