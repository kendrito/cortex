/** Package-owned compaction log-stream invariants. @module @cortex/compaction/invariant */

import type { Context } from '@cortex/cordis'
import { isReplacementSurfaceEvent } from '@cortex/session'
...
const PACKAGE_NAME = '@cortex/compaction'
