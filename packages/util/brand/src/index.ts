 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in cortex-llm (tool-call
 * correlation), the shared agent/session `SessionId` in cortex-session, and
 * `JobId` in cortex-jobs. Branding is for ids that cross package boundaries and
