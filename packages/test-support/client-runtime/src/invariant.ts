/**
 * Package-owned invariant companion for `@cortex/client-test-runtime`.
 * @module @cortex/client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@cortex/client-test-runtime'
