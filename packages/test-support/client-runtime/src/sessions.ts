...
import type { AttachmentIdType } from '@cortex/attachment'
import { createScope, scopeOf, SessionProvideChannel } from '@cortex/client-runtime/client'
...
import type { HostObservable, SessionMaybeProvideInfo, SessionProvideInfo } from '@cortex/client-ui-slots'
