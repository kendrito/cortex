...
import ToolRuntime, { RUN_CODE_NAME, defineContentToolFixture } from '@cortex/tools'
import { Session, SessionId, type UserMessage } from '@cortex/session'
import AgentRegistry, { agentEvents, type Agent } from '@cortex/agent'
...
import { CodeRuntime, type CodeRunRequest, type CodeRunResult } from '@cortex/code-runtime'
...
/**
 * Drives the REAL plugin: mounts `cortex-plan-mode` beside real `SystemPrompt` and
