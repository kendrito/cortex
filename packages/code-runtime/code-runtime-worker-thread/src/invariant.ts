/**
 * Package-owned invariant companion for `@cortex/code-runtime-worker-thread`.
 * @module @cortex/code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@cortex/code-runtime-worker-thread'
