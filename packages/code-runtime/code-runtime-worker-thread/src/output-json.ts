/** JSON string-prefix accounting for the outer-output ledger. @module @cortex/code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@cortex/code-runtime'
