 ...
 *
 * `cortex-system-prompt` owns the global persona as its own config, and registers
 ...
 * exactly like the per-child persona `cortex-subagent` installs; mounted globally
...
import { PERSONA_ORDER, PERSONA_SECTION } from '@cortex/system-prompt'
