/**
 * Package-owned invariant companion for `@cortex/agent-presets`.
 * @module @cortex/agent-presets/invariant
 */
...
// joins, and the `agent` field `cortex-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from '@cortex/agent-presets'

const PACKAGE_NAME = '@cortex/agent-presets'
