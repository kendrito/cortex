 ...
 * @module @cortex/agent-presets/discovery
 */
...
import { expandHomePath } from '@cortex/home-paths'
 ...
 *
 * This package owns the writable root the way `cortex-skill-filesystem` owns
 * `<cortexHome>/skills`. An app must assemble the SHIPPED root, whose path only
