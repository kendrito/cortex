 ...
 * @module @cortex/agent-presets/mount
 */
...
import type { EntryTree } from '@cortex/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@cortex/scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@cortex/*` row would fail to import. The
 ...
 * invariant companion's service listener, and `cortex-invariants` is a
