...
import type { ApprovalRequestId } from '@cortex/user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@cortex/host-apiproxy/api'
import type { RpcId } from '@cortex/host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@cortex/host-apiproxy/api/rpc'
