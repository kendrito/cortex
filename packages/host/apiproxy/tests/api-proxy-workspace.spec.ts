...
import type { Agent, AgentFactory } from '@cortex/agent'
import SessionStore, { SessionId } from '@cortex/session'
import type { Session } from '@cortex/session'
import Storage from '@cortex/storage'
import { DomainFacility } from '@cortex/storage-domain'
import UserQuestionService from '@cortex/user-questions'
import { DirectoryPickerError } from '@cortex/host-directory-picker'
import type { DirectoryPickerCapability } from '@cortex/host-directory-picker'
import WorkspaceRegistry from '@cortex/workspace'
import type { HostFrame, WorkspaceId } from '@cortex/host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@cortex/host-apiproxy/api/rpc'
...
async function harness(
  root = realpathSync.native(mkdtempSync(join(tmpdir(), 'cortex-apiproxy-workspace-'))),
