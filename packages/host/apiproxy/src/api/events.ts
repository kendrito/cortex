...
import type { AskUserQuestionItem } from '@cortex/user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@cortex/user-approval/types'
import type { Message } from '@cortex/llm/types'
import type { MessageId } from '@cortex/llm/brand'
import type { CallId } from '@cortex/llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@cortex/session/types'
import type { ToolCallView, ToolResultView } from '@cortex/tools/presentation'
import type { RpcError, RpcId, RpcRequest } from './rpc.ts'
import type { JobView } from './jobs.ts'
import type { WorkspaceView } from './workspace.ts'

// Client-side consumers take the render-intent vocabulary from the contract;
// cortex-tools remains its owner.
...
export type HostFrame =
   ...
   * owned by `@cortex/api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
