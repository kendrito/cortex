...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef } from '@cortex/attachment'
 ...
 * the cortex-tools vocabulary into this schema and drift with it.
 */
