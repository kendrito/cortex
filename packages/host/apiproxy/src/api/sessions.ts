...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@cortex/attachment'
import type { ContentBlock } from '@cortex/llm/types'
import type { SessionEvent, SessionId } from '@cortex/session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via cortex-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@cortex/session-projection/types'
