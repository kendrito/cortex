/** Package-owned invariant companion for the directory-picker seam. @module @cortex/host-directory-picker/invariant */

import type { Context } from '@cortex/cordis'
import type { InvariantInstaller } from '@cortex/invariants'

const PACKAGE_NAME = '@cortex/host-directory-picker'
