/**
 * Package-owned invariant companion for `@cortex/host-frontend-static`.
 * @module @cortex/host-frontend-static/invariant
 */

import type { Context } from '@cortex/cordis'
import type { InvariantInstaller } from '@cortex/invariants'

const PACKAGE_NAME = '@cortex/host-frontend-static'
