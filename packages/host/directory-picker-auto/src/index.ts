 ...
 * @module @cortex/host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@cortex/host-directory-picker-native',
  browse: '@cortex/host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@cortex/client-ui-directory-picker-native',
  browse: '@cortex/client-ui-directory-picker-browse',
}
