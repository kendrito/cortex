...
import GoalService, { GoalId } from '@cortex/goal'
import type { GoalRef } from '@cortex/goal'
import { createUserMessage, CallId } from '@cortex/llm'
import type { MessageSource } from '@cortex/llm'
...
describe('goal tool execution authority', () => {
  it('lets a root model infer create intent from its accepted human turn', async () => {
    ...
    openTurn(root, { kind: 'user' }, 'Keep working until this feature is done')
