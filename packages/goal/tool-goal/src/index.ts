 ...
 * @module @cortex/tool-goal
 */

import type { Context } from '@cortex/cordis'
import z from '@cortex/schemastery'
import { GoalId } from '@cortex/goal'
import type { GoalRef, GoalView } from '@cortex/goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@cortex/llm'
import { defineTool } from '@cortex/tools'
import type { GenericCallView } from '@cortex/tools'
