...
import AgentRegistry, { agentEvents, Inbox } from '@cortex/agent'
import type { Agent } from '@cortex/agent'
import { createUserMessage, HarnessError } from '@cortex/llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@cortex/session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
...
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@cortex/goal'
...
function stubAgent(rawId: string, seed?: readonly import('@cortex/session').SessionEvent[]): StubAgent {
