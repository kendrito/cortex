...
import * as GoalSessionInvariant from '@cortex/goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@cortex/goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@cortex/goal-round-driver',
    }))
  })
