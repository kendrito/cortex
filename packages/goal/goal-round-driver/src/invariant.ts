/** Package-owned goal-round prompt invariants. @module @cortex/goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@cortex/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@cortex/goal'
import type { InvariantFailure, InvariantInstaller } from '@cortex/invariants'
import type { Session, SessionEvent } from '@cortex/session'
import { renderGoalRoundPrompt } from './prompt.ts'

const PACKAGE_NAME = '@cortex/goal-round-driver'
