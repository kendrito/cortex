...
- id: tool-goal
  name: '@cortex/tool-goal'

- id: goal-round-driver
  name: '@cortex/goal-round-driver'
```

The plugin has no tunable configuration. `maxGoalRounds` belongs to the goal definition, while the model-facing blocked threshold belongs to [`cortex-tool-goal`](../tool-goal/README.md); duplicating either value in the driver could produce divergent policy.
