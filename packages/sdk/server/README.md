...
- **No automatic adapter mounting** — `initialize` reuses a pre-registered model adapter for the requested provider and has no fallback; the surrounding composition must register the route.
