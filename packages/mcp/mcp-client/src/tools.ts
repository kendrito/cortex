 ...
 * is `mcp__<serverName>__<rawName>`, normalized to the Cortex function-name
...
import type { ToolDefinition, ToolExecution } from '@cortex/tools'
import { assertSupportedJsonSchema } from '@cortex/tools'
import type { JsonSchemaNode, JsonValue } from '@cortex/tools'
...
/**
 * Cortex function-name contract: at most 64 characters. Wire-protocol
 * constant, not configuration.
 */
const MAX_PUBLIC_NAME_LENGTH = 64

/** Cortex function-name contract: only `[A-Za-z0-9_-]` is allowed. */
 ...
 * truncation to the Cortex function-name contract (64 chars,
