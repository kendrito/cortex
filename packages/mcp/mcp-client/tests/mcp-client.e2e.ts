/**
 * End-to-end tests for cortex-mcp-client. Exercises the REAL MCP protocol against:
...
import { apply } from '@cortex/mcp-client/src/index.ts'
import { publicToolName } from '@cortex/mcp-client/src/tools.ts'
