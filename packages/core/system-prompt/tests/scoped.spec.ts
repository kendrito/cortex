...
import { createScope, scopeOf } from '@cortex/scope'
import type { Scope, ScopeKey } from '@cortex/scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@cortex/system-prompt'
import type { Config, PromptAssembly } from '@cortex/system-prompt'
