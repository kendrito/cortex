...
import { Context, symbols, type EffectMeta, type Fiber } from '@cortex/cordis'
...
import AgentRegistry, { agentEvents, assembleContextFor } from '@cortex/agent'

import type { Agent } from '@cortex/agent'
import { scopeOf } from '@cortex/scope'
