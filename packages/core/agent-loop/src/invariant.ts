 ...
 * @module @cortex/agent-loop/invariant
 */

import type { Context } from '@cortex/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@cortex/llm'
import type { InvariantFailure, InvariantInstaller } from '@cortex/invariants'
import { foldRequestHeader } from '@cortex/session'

const PACKAGE_NAME = '@cortex/agent-loop'
