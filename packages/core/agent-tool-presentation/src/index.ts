 ...
 * ([`cortex-code-runtime-worker-thread`](../../code-runtime/code-runtime-worker/README.md)).
 ...
 * @module @cortex/agent-tool-presentation
 */

import type { Context } from '@cortex/cordis'
import z from '@cortex/schemastery'
import type { ToolPresentationMode } from '@cortex/tools'
...
export function apply(ctx: Context, config: Config): void {
  ...
  // what `cortex-agent-presets` reports as an unusable row, naming this id.
