 ...
 * store, keyed by the loaded {@link @cortex/code-runtime#CodeRuntime.language | code
 * runtime's language}.
 *
 ...
 * @module @cortex/tools/src/py-types
 */
 ...
 * syllable composes with a following V or T jamo head (U+AC00 + U+11A8 gives U+AC01),
