/**
 * Package-owned invariant companion for `@cortex/credentials-local`.
 * @module @cortex/credentials-local/invariant
 */
...
const PACKAGE_NAME = '@cortex/credentials-local'
...
/**
 * No runtime invariant: the Service Definition companion (`cortex-credentials/invariant`) owns the
