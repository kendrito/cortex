 ...
 *
 * Fidelity to the backend contract (`cortex-storage` `src/backend.ts`): version
...
import { StorageError } from '@cortex/storage'
import type { KvFacet, KvUnit, KvUnitDescriptor, StorageBackend } from '@cortex/storage'
