 ...
 * mapping; shared execution and parsing live in `cortex-hook-protocol`.
 ...
 * @module @cortex/hooks-claude-code
 */
...
import type { UserMessage } from '@cortex/session'
import type {} from '@cortex/session-persistence'
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@cortex/tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
