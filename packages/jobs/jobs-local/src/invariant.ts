/**
 * Package-owned invariant companion for `@cortex/jobs-local`.
 * @module @cortex/jobs-local/invariant
 */
...
const PACKAGE_NAME = '@cortex/jobs-local'
...
/**
 * No runtime invariant: `@cortex/jobs/invariant` owns per-snapshot identity, status,
