/**
 * The bundle's substance is its patch file: the `cortex.bundle.patch` manifest
...
describe('cortex-base bundle', () => {
  it('declares a parseable patch list through the cortex.bundle.patch manifest field', () => {
