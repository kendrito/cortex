...
This overlay opts one `cortex web` process into Schedule reminders without changing the shipped default Web composition:

```sh
cortex web --patch examples/web-schedule/cordis.yml
```
