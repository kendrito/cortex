...
def main() -> None:
    ...
    parser.add_argument("--session-root", type=Path, default=Path(".cortex-sessions"))
    parser.add_argument("--session-id")
    parser.add_argument("--provider", default="cortex-official")
    parser.add_argument("--model", default=os.environ.get("CORTEX_MODEL", "cortex-v4-flash"))
