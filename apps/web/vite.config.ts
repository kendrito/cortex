...
const STANDALONE_ERROR = 'apps/web is not a standalone application: bare Vite cannot inject window.__CORTEX_BOOT__. '
  + 'From a repository checkout, run `pnpm cortex web`; an installed package uses `cortex web`. '
  + 'For client-plugin HMR, run `pnpm cortex web` together with `pnpm run dev:web`.'

/** Fail before a Vite dev or preview server can expose the boot-manifest-free shell. */
function rejectStandaloneServe(): Plugin {
  return {
    name: 'cortex-reject-standalone-web-serve',
    config(_config, env) {
...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: /^@cortex\/client-web$/, replacement: src('../../packages/client/web/src/boot.tsx') },
      { find: /^@cortex\/client-web-react$/, replacement: src('../../packages/client/web-react/src/index.ts') },
      { find: /^@cortex\/client-ui-slots$/, replacement: src('../../packages/client/ui-slots/src/index.ts') },
      { find: /^@cortex\/client-ui-primitives$/, replacement: src('../../packages/client/ui-primitives/src/index.ts') },
      { find: /^@cortex\/client-ui-attachment$/, replacement: src('../../packages/client/ui-attachment/src/index.ts') },
      { find: /^@cortex\/client-schema-form$/, replacement: src('../../packages/client/schema-form/src/index.ts') },
      { find: /^@cortex\/client-modules\/client$/, replacement: src('../../packages/client/modules/src/client/index.ts') },
    ],
  },
  define: {
