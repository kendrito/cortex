- banner:
  ...
  - tablist:
    - tab "Chat" [selected]
    - tab "Trajectory"
- text: Use web_search to search exactly "Cortex snapshot search". Then reply exactly SEARCH_DONE and stop. {{clock}}
- button "Copy":
  - img
...
- button "Search Cortex snapshot search":
  - img
  - img
  - text: Search Cortex snapshot search
