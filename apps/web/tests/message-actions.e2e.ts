...
function completedTailFixture(raw: string): string {
  ...
  const tail = [
    ...
    { type: 'assistant/message', seq: 106, time: 1784974103003, data: { turn: 2, step: 1, content: [{ type: 'text', text: 'DONE' }], provenance: { provider: 'cortex-official', model: 'cortex-v4-flash' } }, sourceEventSeqs: [], surfaceOp: 'append' },
