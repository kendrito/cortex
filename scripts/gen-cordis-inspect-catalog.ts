...
import type { CordisCatalogModel, ServiceMethodEntry } from '@cortex/typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@cortex/tool-cordis/api-catalog', '@cortex/cordis-client-runner/client/api-catalog')
