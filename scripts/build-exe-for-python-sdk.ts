...
const DEPLOY_ROOT_PACKAGE = 'cortex-jsonrpc-agent-pkg'
/** The closed-runtime app entry inside the deployed closure. */
const ENTRY_BIN = 'node_modules/@cortex/sdk-jsonrpc-demo/lib/packaged-bin.js'
const OUTPUT_BASENAME = 'cortex-jsonrpc-agent-pkg'
...
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/cortex_harness_runtime/runtime'
