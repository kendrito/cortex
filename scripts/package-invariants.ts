...
function checkManifest(
  ...
  if (owner.packageName === '@cortex/invariants') return
  if (manifest.peerDependencies?.['@cortex/invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@cortex/invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@cortex/invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@cortex/invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@cortex/invariants'
