/**
 * Junction-safe fixture cleanup for Windows. Test fixtures may junction REAL
 * repository directories so installer probes resolve through them; Windows recursive deletion — both Node's `rmSync` and
