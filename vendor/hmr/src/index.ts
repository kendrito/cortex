import { Context, Service, type Plugin } from '@cortex/cordis'
import type { Dict } from '@cortex/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@cortex/cordis-plugin-loader'
...
import type {} from '@cortex/cordis-plugin-timer'
...
namespace Hmr {
  ...
  // [cortex] vendored modification: removed the `.i18n({...})` locale bundles
