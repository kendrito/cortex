import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@cortex/cordis-plugin-loader'
 ...
 * (`cortex --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`cortex --dump-config`) so a dump can never drift from what boots. The input
